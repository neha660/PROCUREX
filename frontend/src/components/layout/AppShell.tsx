...
export function AppShell() {
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="min-h-screen bg-ink-950 lg:grid lg:grid-cols-[17rem_1fr]">
        <aside className="hidden lg:block border-r border-line bg-ink-950 sticky top-0 h-screen">
        ...
        <div className="flex flex-col min-h-screen min-w-0">
          <TopBar
            ...
            navBadges={navBadges}
          />
          <main id="main-content" className="flex-1 px-4 md:px-6 lg:px-8 py-6 md:py-8 max-w-[1600px]">
            <Outlet context={context} />
          </main>
          <footer className="px-4 md:px-6 lg:px-8 py-8 text-xs text-text-dim font-mono border-t border-line">
